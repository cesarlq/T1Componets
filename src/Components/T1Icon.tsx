// T1Icon.tsx - Mantén tus imports EXACTAMENTE como los tienes
import Image from 'next/image';
import { PBIconProps } from '../interfaces/commonInterfaces';
import React from 'react';

// MANTÉN todos tus imports exactamente como están
...
const T1Icon: React.FC<PBIconProps> = ({ icon, width, height, sx, className }) => {
	const iconMap: { [key: string]: any } = {
		...
		menuInActive: MenuInActive // ← Agregar este mapeo
	};

	const iconSrc = iconMap[icon] || BannerIcon;
	
	// Usar img nativo porque ahora iconSrc será un data URL (base64)
	return (
		<img 
			src={iconSrc} 
			alt="Icon" 
