import{j as e}from"./jsx-runtime-DoEZbXM1.js";import{r as o}from"./index-BXymfbzT.js";import{c as C}from"./CommonStyles.module-D_--k38T.js";import{T as F}from"./T1Icon-BhL2WAyO.js";import{I as ce}from"./InputAdornment-BoGHSgZW.js";import{I as pe}from"./IconButton-DirQ0k3w.js";import{B as i}from"./Box-DZedOxc9.js";import{T as f,P as Ja}from"./Typography-BX-3pE5G.js";import{T as Qa}from"./Tooltip-BU1sWs4i.js";import{T as Xa}from"./TextField-CUPchR4D.js";import{F as Za}from"./Select-DSLAnD-8.js";import{M as v}from"./MenuItem-DXaFae9B.js";import{S as Y}from"./Stack-Czdk5DBX.js";import"./jsx-runtime-Bw5QeaCk.js";import"./image-DwLHI-Re.js";import"./image-context-9EevjYAT.js";import"./index-DGKHe-6Q.js";import"./settings-icon-CWecReMl.js";import"./styled-SyO28NtG.js";import"./defaultTheme-JuPGuWN_.js";import"./useFormControl-hi_-Bm5a.js";import"./memoTheme-BXN-JR5D.js";import"./DefaultPropsProvider-B6e4UF29.js";import"./createSimplePaletteValueFilter-KjEIrzYP.js";import"./useEnhancedEffect-mdVbf1Yy.js";import"./useId-iqt95REQ.js";import"./ButtonBase-Dif9QXL2.js";import"./CircularProgress-DrS-PuOE.js";import"./extendSxProp-B_gxhBfW.js";import"./index-Dq15nN1B.js";import"./useControlled-5dYq2F3P.js";import"./Grow-CB6s9QXY.js";import"./index-D4B05_Au.js";import"./Menu-C5VpKsmr.js";import"./MenuList-B9OW0zET.js";import"./createSvgIcon-DNN30dVJ.js";import"./listItemTextClasses-5YqA4Sa_.js";import"./dividerClasses-B96QDxXS.js";import"./getThemeProps-CUHTK0IK.js";const r=o.forwardRef(({label:s,required:d=!1,disabled:u=!1,readOnly:t=!1,textFieldProps:a={},value:c,defaultValue:L,placeholder:ma,error:G,helperText:ha,validation:b,maxLength:p,minLength:D,validateOnBlur:fa=!0,validateOnChange:ba=!1,onChange:y,onBlur:J,onFocus:Q,onEnterPress:X,autoFocus:ga=!1,clearable:O=!1,tooltip:Z,tooltipPlacement:va="top",startIcon:ee,endIcon:U,variant:ya="outlined",size:xa="medium",style:Ca,sx:Ta,labelSx:Sa,inputSx:wa,helperTextSx:Ra,borderRadius:er,borderColor:Wa,focusBorderColor:Ia,fullWidth:ae=!1,hideLabel:Ea=!1,compact:ar=!1,customStyles:l,showCharCount:qa=!1,children:Va,...ja},Pa)=>{var se,oe,ie,ue,de;const[m,K]=o.useState(c!==void 0?String(c):L!==void 0?String(L):""),[Ba,re]=o.useState(!1),[te,g]=o.useState({isValid:!0}),[x,Ma]=o.useState(!1);o.useEffect(()=>{c!==void 0&&K(String(c))},[c]);const ka=n=>{const h=n.target.value;if(!(p&&h.length>p)){if(K(h),ba&&b){const _=b(h);g(typeof _=="boolean"?{isValid:_}:_)}y&&y(n),"onChange"in a&&typeof a.onChange=="function"&&a.onChange(n)}},za=n=>{if(re(!1),fa&&b){const h=b(m);g(typeof h=="boolean"?{isValid:h}:h)}D&&m.length<D&&m.length>0&&g({isValid:!1,message:`Debe tener al menos ${D} caracteres`}),J&&J(n),"onBlur"in a&&typeof a.onBlur=="function"&&a.onBlur(n)},Na=n=>{re(!0),Q&&Q(n),"onFocus"in a&&typeof a.onFocus=="function"&&a.onFocus(n)},Aa=n=>{n.key==="Enter"&&X&&X(),"onKeyDown"in a&&typeof a.onKeyDown=="function"&&a.onKeyDown(n)},Ha=()=>{K("");const n={target:{value:""}};y&&y(n),"onChange"in a&&typeof a.onChange=="function"&&a.onChange(n)},Fa=()=>{Ma(!x)},La=a.type==="password"?x?"text":"password":a.type,Da=ee?e.jsx(ce,{position:"start",children:ee}):(se=a.InputProps)==null?void 0:se.startAdornment;let ne=e.jsxs(ce,{position:"end",children:[O&&m&&!u&&!t&&e.jsx(pe,{onClick:Ha,edge:"end",size:"small","aria-label":"clear input",children:e.jsx(F,{icon:"closeIcon"})}),a.type==="password"&&e.jsx(pe,{onClick:Fa,edge:"end",size:"small","aria-label":x?"hide password":"show password",children:e.jsx(F,{icon:x?"eyeOffIcon":"eyeIcon"})}),U,!O&&!a.type&&!U&&((oe=a.InputProps)==null?void 0:oe.endAdornment)]});!O&&a.type!=="password"&&!U&&!((ie=a.InputProps)!=null&&ie.endAdornment)&&(ne=e.jsx(e.Fragment,{}));const $=G!==void 0?G:b?!te.isValid:!1,le=te.message||ha,Oa=()=>$?{borderColor:"#d32f2f"}:Ba?{borderColor:Ia||"#1976d2"}:{borderColor:Wa||"#c4c4c4"},Ua=p?`${m.length}/${p}`:void 0,Ka={width:ae?"100%":"auto",...Ca,...l==null?void 0:l.container},$a={fontWeight:"500",fontSize:"12px",lineHeight:"100%",letterSpacing:"0%",...l==null?void 0:l.label},_a={borderRadius:"12px!important",...Oa(),...l==null?void 0:l.input},Ya={...l==null?void 0:l.helperText},Ga="className"in a?a.className:"";return e.jsxs(i,{ref:Pa,className:`${C.container} ${Ga}`,style:Ka,sx:{display:"flex",flexDirection:"column",...Ta},children:[!Ea&&s&&e.jsxs(i,{className:C["label-container"],sx:{display:"flex",alignItems:"center",mb:.5,...Sa},children:[e.jsxs(f,{variant:"body2",component:"label",className:C.label,style:$a,sx:{fontWeight:500},children:[s,d&&e.jsx(i,{component:"span",sx:{color:"error.main",ml:.5},children:"*"})]}),Z&&e.jsx(Qa,{title:Z,placement:va,children:e.jsx(i,{className:C.tooltip,sx:{ml:.5,display:"flex",alignItems:"center"},children:e.jsx(F,{icon:"helpIcon"})})})]}),e.jsx(Xa,{...ja,...a,value:"value"in a?a.value:m,defaultValue:"defaultValue"in a?a.defaultValue:L,onChange:ka,onBlur:za,onFocus:Na,onKeyDown:Aa,error:$,disabled:u||("disabled"in a?a.disabled:!1),placeholder:ma||("placeholder"in a?a.placeholder:""),variant:ya,size:xa,fullWidth:ae||("fullWidth"in a?a.fullWidth:!1),autoFocus:ga||("autoFocus"in a?a.autoFocus:!1),InputProps:{...a.InputProps,readOnly:t||(((ue=a.InputProps)==null?void 0:ue.readOnly)??!1),startAdornment:Da,endAdornment:ne,sx:{..._a,height:"35px",...(de=a.InputProps)==null?void 0:de.sx,...wa}},inputProps:{..."inputProps"in a?a.inputProps:{},maxLength:p,type:La},children:"select"in a&&a.select&&Va}),e.jsxs(i,{sx:{display:"flex",justifyContent:"space-between",alignItems:"center",mt:.5,minHeight:"1.25rem"},children:[le&&e.jsx(Za,{error:$,style:Ya,sx:{m:0,...Ra},children:le}),qa&&p&&e.jsx(f,{variant:"caption",sx:{color:m.length>=p?"error.main":"text.secondary",ml:"auto",fontSize:"0.75rem"},children:Ua})]})]})});r.displayName="CustomInput";r.__docgenInfo={description:`CustomInput es un componente de entrada mejorado con funciones extendidas como validación,
...
}`,...(ta=(ra=z.parameters)==null?void 0:ra.docs)==null?void 0:ta.source}}};var na,la,sa;N.parameters={...N.parameters,docs:{...(na=N.parameters)==null?void 0:na.docs,source:{originalSource:`{
  render: () => {
...
}`,...(sa=(la=N.parameters)==null?void 0:la.docs)==null?void 0:sa.source}}};var oa,ia,ua;A.parameters={...A.parameters,docs:{...(oa=A.parameters)==null?void 0:oa.docs,source:{originalSource:`{
  render: () => {
